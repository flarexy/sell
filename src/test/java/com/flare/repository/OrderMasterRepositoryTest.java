...
public class OrderMasterRepositoryTest {
    ...
    public void saveTest() {
        ...
        orderMaster.setOrderId("1112");
        orderMaster.setBuyerName("熠");
        orderMaster.setBuyerPhone("12345678912");
        orderMaster.setBuyerAddress("厦门");
        orderMaster.setBuyerOpenid("110110");
        orderMaster.setOrderAmount(new BigDecimal(33.5));
    ...
    public void findByBuyerOpenid() {
        ...
        Page<OrderMaster> orderMasterPage = repository.findByBuyerOpenid(OPEDID,request);
